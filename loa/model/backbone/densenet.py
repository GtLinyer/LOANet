...
class _DenseLayer(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(num_input_features, bn_size * growth_rate, kernel_size=(1, 1), stride=(1, 1), bias=False)

        self.norm2 = nn.BatchNorm2d(bn_size * growth_rate)
        self.relu2 = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(bn_size * growth_rate, growth_rate, kernel_size=(3, 3), stride=(1, 1), padding=1, bias=False)
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.conv = nn.Conv2d(num_input_features, num_output_features, kernel_size=(1, 1), stride=(1, 1), bias=False)
